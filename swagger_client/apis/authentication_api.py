...
class AuthenticationApi(object):
    ...
    def authenticate_user(self, api_key, **kwargs):
        """
        authenticateUser
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.authenticate_user(api_key, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str api_key: API key required to make the API call. (required)
        :param AuthenticateUser authenticate_user:
        :return: AuthResponse
        ...
        if kwargs.get('callback'):
            return self.authenticate_user_with_http_info(api_key, **kwargs)
        else:
            (data) = self.authenticate_user_with_http_info(api_key, **kwargs)
            return data

    def authenticate_user_with_http_info(self, api_key, **kwargs):
        """
        authenticateUser
        Before calling any other API methods, you must first authenticate to the API.  Call this method to get an accessToken, and then pass this token back to each API call. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.authenticate_user_with_http_info(api_key, callback=callback_function)
        ...
        all_params = ['api_key', 'authenticate_user']
        ...
        body_params = None
        if 'authenticate_user' in params:
            body_params = params['authenticate_user']
        # HTTP header `Accept`
    ...
    def logout_user(self, api_key, **kwargs):
        """
        logoutUser
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.logout_user(api_key, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str api_key: API key required to make the API call. (required)
        :param LogoutUser logout_user:
        :return: Response
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.logout_user_with_http_info(api_key, **kwargs)
        else:
            (data) = self.logout_user_with_http_info(api_key, **kwargs)
            return data

    def logout_user_with_http_info(self, api_key, **kwargs):
        """
        logoutUser
        Invalidate a user's access token, rendering it unable to make further API calls.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.logout_user_with_http_info(api_key, callback=callback_function)
        ...
        all_params = ['api_key', 'logout_user']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        body_params = None
        if 'logout_user' in params:
            body_params = params['logout_user']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
