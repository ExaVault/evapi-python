...
class UserApi(object):
    ...
    def create_user(self, api_key, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_user(api_key, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.create_user_with_http_info(api_key, **kwargs)
        else:
            (data) = self.create_user_with_http_info(api_key, **kwargs)
            return data

    def create_user_with_http_info(self, api_key, **kwargs):
        """
        createUser
        Adds a new user to the account. The user may be configured as an admin or standard user, and (if a standard user) may be assigned a restricted home directory and restricted permissions.  > **Notes:** - Authenticated user's role must be admin or master; standard users are not allowed to create other users. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_user_with_http_info(api_key, callback=callback_function)
        ...
        all_params = ['api_key', 'create_user']
    ...
    def update_user(self, api_key, **kwargs):
        """
        updateUser
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user(api_key, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_user_with_http_info(api_key, **kwargs)
        else:
            (data) = self.update_user_with_http_info(api_key, **kwargs)
            return data

    def update_user_with_http_info(self, api_key, **kwargs):
        """
        updateUser
        Updates specified user record in your account. Note that the unique key for this API call is our internal ID, and _not_ the username, as the username can be changed.   > **Notes:** - Authenticated user's role must be admin or master. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_user_with_http_info(api_key, callback=callback_function)
        ...
        all_params = ['api_key', 'update_user']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
