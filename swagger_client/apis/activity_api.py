...
class ActivityApi(object):
    ...
    def get_file_activity_logs(self, api_key, access_token, **kwargs):
        """
        getFileActivityLogs
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_file_activity_logs(api_key, access_token, callback=callback_function)
        ...
        :param int offset: Starting record in the result set. Can be used for pagination.
        :param str sort_by: Sort method.
        :param str sort_order: Sort order.
        :param str filter_by: Field to search on
        :param str filter: Search criteria. For date ranges, use format 'start_date::end_date'.
        :param int item_limit: Number of logs to return. Can be used for pagination.
        :return: LogResponse
        ...
        if kwargs.get('callback'):
            return self.get_file_activity_logs_with_http_info(api_key, access_token, **kwargs)
        else:
            (data) = self.get_file_activity_logs_with_http_info(api_key, access_token, **kwargs)
            return data

    def get_file_activity_logs_with_http_info(self, api_key, access_token, **kwargs):
        """
        getFileActivityLogs
        Get the activity log from your account. Activity logs contain information on all operations in your account &ndash; connecting, uploading and downloading files, sharing, setting up notifications, and more. You can use different filter and sorting options to get the exact data you need.  **Notes:**  - The authenticated user's role must be admin or master in order to pull activity logs. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_file_activity_logs_with_http_info(api_key, access_token, callback=callback_function)
        ...
        all_params = ['api_key', 'access_token', 'offset', 'sort_by', 'sort_order', 'filter_by', 'filter', 'item_limit']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_file_activity_logs" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_file_activity_logs`")
        # verify the required parameter 'access_token' is set
        if ('access_token' not in params) or (params['access_token'] is None):
            raise ValueError("Missing the required parameter `access_token` when calling `get_file_activity_logs`")
        ...
        if 'filter_by' in params:
            query_params.append(('filterBy', params['filter_by']))
        if 'filter' in params:
            query_params.append(('filter', params['filter']))
        if 'item_limit' in params:
            query_params.append(('itemLimit', params['item_limit']))
        ...
        return self.api_client.call_api('/getFileActivityLogs', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_notification_activity(self, api_key, access_token, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_notification_activity(api_key, access_token, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_notification_activity_with_http_info(api_key, access_token, **kwargs)
        else:
            (data) = self.get_notification_activity_with_http_info(api_key, access_token, **kwargs)
            return data

    def get_notification_activity_with_http_info(self, api_key, access_token, **kwargs):
        """
        getNotificationActivity
        Get all notification messages for the authenticated user. Notification messages are only recorded if a notification has been setup for a folder, and an action is taken (e.g. a file upload) in the given folder.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_notification_activity_with_http_info(api_key, access_token, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_notification_activity" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_notification_activity`")
        # verify the required parameter 'access_token' is set
        if ('access_token' not in params) or (params['access_token'] is None):
            raise ValueError("Missing the required parameter `access_token` when calling `get_notification_activity`")
        ...
        return self.api_client.call_api('/getNotificationActivity', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='NotificationActivityResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def get_share_activity(self, api_key, access_token, id, **kwargs):
        """
        getShareActivity
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_share_activity(api_key, access_token, id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_share_activity_with_http_info(api_key, access_token, id, **kwargs)
        else:
            (data) = self.get_share_activity_with_http_info(api_key, access_token, id, **kwargs)
            return data

    def get_share_activity_with_http_info(self, api_key, access_token, id, **kwargs):
        """
        getShareActivity
        Get all share activity for the specified share ID. Share activity includes anything which happened on the share in question &ndash; for example, a user being invited or a user connecting and downloading files.  **Notes:**  - Authenticated user must be the owner of the specified share. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_share_activity_with_http_info(api_key, access_token, id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_share_activity" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params) or (params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `get_share_activity`")
        # verify the required parameter 'access_token' is set
        if ('access_token' not in params) or (params['access_token'] is None):
            raise ValueError("Missing the required parameter `access_token` when calling `get_share_activity`")
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_share_activity`")
        ...
        return self.api_client.call_api('/getShareActivity', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='ShareActivityResponse',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
