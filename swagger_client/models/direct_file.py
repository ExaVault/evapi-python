...
class DirectFile(object):
    ...
    def __init__(self, id=None, account_id=None, path=None, is_enabled=None, is_index_enabled=None, block_until=None, created=None, modified=None):
        """
        DirectFile - a model defined in Swagger
        """
        ...
        if is_index_enabled is not None:
          self.is_index_enabled = is_index_enabled
    ...
    def id(self):
        """
        Gets the id of this DirectFile.
        ID of the direc file object.

        :return: The id of this DirectFile.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this DirectFile.
        ID of the direc file object.

        :param id: The id of this DirectFile.
        :type: int
        """
    ...
    def account_id(self):
        """
        Gets the account_id of this DirectFile.
        ID of the account this direct file object belongs to.

        :return: The account_id of this DirectFile.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """
        Sets the account_id of this DirectFile.
        ID of the account this direct file object belongs to.

        :param account_id: The account_id of this DirectFile.
        :type: str
        """
    ...
    def path(self):
        """
        Gets the path of this DirectFile.
        Path to the folder direct file is set on.

        :return: The path of this DirectFile.
        :rtype: str
        """
        return self._path
    ...
    def path(self, path):
        """
        Sets the path of this DirectFile.
        Path to the folder direct file is set on.

        :param path: The path of this DirectFile.
        :type: str
        """
    ...
    def is_enabled(self):
        """
        Gets the is_enabled of this DirectFile.
        Flag indicates if direct file is turned `on` or `off`.

        :return: The is_enabled of this DirectFile.
        :rtype: str
        """
    ...
    def is_enabled(self, is_enabled):
        """
        Sets the is_enabled of this DirectFile.
        Flag indicates if direct file is turned `on` or `off`.

        :param is_enabled: The is_enabled of this DirectFile.
        :type: str
        """
    ...
    @property
    def is_index_enabled(self):
        """
        Gets the is_index_enabled of this DirectFile.
        Flag indicates if folder listing is `on` or `off`. If it is enabled you can see folder content in the browser.

        :return: The is_index_enabled of this DirectFile.
        :rtype: str
        """
        return self._is_index_enabled

    @is_index_enabled.setter
    def is_index_enabled(self, is_index_enabled):
        """
        Sets the is_index_enabled of this DirectFile.
        Flag indicates if folder listing is `on` or `off`. If it is enabled you can see folder content in the browser.

        :param is_index_enabled: The is_index_enabled of this DirectFile.
        :type: str
        """

        self._is_index_enabled = is_index_enabled

    @property
    def block_until(self):
        """
        Gets the block_until of this DirectFile.
        ...
        :return: The block_until of this DirectFile.
        :rtype: str
        """
        return self._block_until

    @block_until.setter
    def block_until(self, block_until):
        """
        Sets the block_until of this DirectFile.
        Timestamp of direct file block until date. Equals `0000-00-00 00:00:00` when no block date is setup. Used when direct file bandwidth quota limit crossed.

        :param block_until: The block_until of this DirectFile.
        :type: str
        """
    ...
    def created(self):
        """
        Gets the created of this DirectFile.
        Unix timestamp of direct file creation.

        :return: The created of this DirectFile.
        :rtype: str
        """
    ...
    def created(self, created):
        """
        Sets the created of this DirectFile.
        Unix timestamp of direct file creation.

        :param created: The created of this DirectFile.
        :type: str
        """
    ...
    def modified(self):
        """
        Gets the modified of this DirectFile.
        Unix timestamp of direct file modification.

        :return: The modified of this DirectFile.
        :rtype: str
        """
    ...
    def modified(self, modified):
        """
        Sets the modified of this DirectFile.
        Unix timestamp of direct file modification.

        :param modified: The modified of this DirectFile.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DirectFile):
            return False
