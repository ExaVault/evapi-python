...
class NotificationsResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        NotificationsResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this NotificationsResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this NotificationsResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this NotificationsResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this NotificationsResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this NotificationsResponse.

        :return: The error of this NotificationsResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this NotificationsResponse.

        :param error: The error of this NotificationsResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this NotificationsResponse.
        Array of Notification objects.

        :return: The results of this NotificationsResponse.
    ...
    def results(self, results):
        """
        Sets the results of this NotificationsResponse.
        Array of Notification objects.

        :param results: The results of this NotificationsResponse.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NotificationsResponse):
            return False
