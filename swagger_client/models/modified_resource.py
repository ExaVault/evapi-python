...
class ModifiedResource(object):
    ...
    def __init__(self, file=None, destination=None, size=None, success=None):
        """
        ModifiedResource - a model defined in Swagger
        """
    ...
    def file(self):
        """
        Gets the file of this ModifiedResource.
        Path to the resource.

        :return: The file of this ModifiedResource.
        :rtype: str
        """
        return self._file
    ...
    def file(self, file):
        """
        Sets the file of this ModifiedResource.
        Path to the resource.

        :param file: The file of this ModifiedResource.
        :type: str
        """
    ...
    def destination(self):
        """
        Gets the destination of this ModifiedResource.
        Destinsation path of the operation.

        :return: The destination of this ModifiedResource.
        :rtype: str
        """
    ...
    def destination(self, destination):
        """
        Sets the destination of this ModifiedResource.
        Destinsation path of the operation.

        :param destination: The destination of this ModifiedResource.
        :type: str
        """
    ...
    def size(self):
        """
        Gets the size of this ModifiedResource.
        Resource size.

        :return: The size of this ModifiedResource.
        :rtype: int
        """
        return self._size
    ...
    def size(self, size):
        """
        Sets the size of this ModifiedResource.
        Resource size.

        :param size: The size of this ModifiedResource.
        :type: int
        """
    ...
    def success(self):
        """
        Gets the success of this ModifiedResource.
        Flag indicates operation success status. `0` is failure; `1` is success.

        :return: The success of this ModifiedResource.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this ModifiedResource.
        Flag indicates operation success status. `0` is failure; `1` is success.

        :param success: The success of this ModifiedResource.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ModifiedResource):
            return False
