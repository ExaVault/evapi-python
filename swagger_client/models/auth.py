...
class Auth(object):
    ...
    def __init__(self, username=None, access_token=None, mode=None, client_ip=None):
        """
    ...
    def mode(self):
        """
        Gets the mode of this Auth.
        Authentication mode.

        :return: The mode of this Auth.
        :rtype: int
        """
        return self._mode
    ...
    def mode(self, mode):
        """
        Sets the mode of this Auth.
        Authentication mode.

        :param mode: The mode of this Auth.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def client_ip(self):
        """
        Gets the client_ip of this Auth.
        IP address of the authenticated client.

        :return: The client_ip of this Auth.
        :rtype: str
        """
    ...
    def client_ip(self, client_ip):
        """
        Sets the client_ip of this Auth.
        IP address of the authenticated client.

        :param client_ip: The client_ip of this Auth.
        :type: str
        """
