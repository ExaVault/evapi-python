...
class AvailableUser(object):
    ...
    def __init__(self, available=None):
        """
        AvailableUser - a model defined in Swagger
        """
    ...
    def available(self):
        """
        Gets the available of this AvailableUser.
        Flag indicates if username is available.

        :return: The available of this AvailableUser.
        :rtype: bool
        """
    ...
    def available(self, available):
        """
        Sets the available of this AvailableUser.
        Flag indicates if username is available.

        :param available: The available of this AvailableUser.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AvailableUser):
            return False
