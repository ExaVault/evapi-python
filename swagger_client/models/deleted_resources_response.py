...
class DeletedResourcesResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        DeletedResourcesResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this DeletedResourcesResponse.
        ...
        :return: The success of this DeletedResourcesResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this DeletedResourcesResponse.
        Flag indicates API call status. `0` is failure; `1` is success; `2` means partial success - some but not all files were moved, copied or deleted.

        :param success: The success of this DeletedResourcesResponse.
        :type: int
        """
    ...
    def error(self):
        """
        Gets the error of this DeletedResourcesResponse.

        :return: The error of this DeletedResourcesResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this DeletedResourcesResponse.

        :param error: The error of this DeletedResourcesResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this DeletedResourcesResponse.
        

        :return: The results of this DeletedResourcesResponse.
        :rtype: list[DeletedResource]
        """
    ...
    def results(self, results):
        """
        Sets the results of this DeletedResourcesResponse.
        

        :param results: The results of this DeletedResourcesResponse.
        :type: list[DeletedResource]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, DeletedResourcesResponse):
            return False
