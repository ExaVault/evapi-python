...
class ResourceResponse(object):
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        ResourceResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this ResourceResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this ResourceResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this ResourceResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this ResourceResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this ResourceResponse.

        :return: The error of this ResourceResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this ResourceResponse.

        :param error: The error of this ResourceResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this ResourceResponse.
        Array of Resources.

        :return: The results of this ResourceResponse.
        :rtype: Resource
        """
    ...
    def results(self, results):
        """
        Sets the results of this ResourceResponse.
        Array of Resources.

        :param results: The results of this ResourceResponse.
        :type: Resource
        """
