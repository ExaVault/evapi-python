...
class PreviewFileResponse(object):
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        PreviewFileResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this PreviewFileResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this PreviewFileResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this PreviewFileResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this PreviewFileResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this PreviewFileResponse.

        :return: The error of this PreviewFileResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this PreviewFileResponse.

        :param error: The error of this PreviewFileResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this PreviewFileResponse.
        Object with preview properties.

        :return: The results of this PreviewFileResponse.
        :rtype: PreviewFile
        """
    ...
    def results(self, results):
        """
        Sets the results of this PreviewFileResponse.
        Object with preview properties.

        :param results: The results of this PreviewFileResponse.
        :type: PreviewFile
        """
