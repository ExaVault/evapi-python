...
class CreateUser(object):
    ...
    def __init__(self, access_token=None, username=None, nickname=None, destination_folder=None, email=None, password=None, role=None, permissions=None, time_zone=None, expiration=None, locked=False, welcome_email=False):
        """
    ...
    def access_token(self):
        """
        Gets the access_token of this CreateUser.
        Access token required to make the API call.

        :return: The access_token of this CreateUser.
        :rtype: str
        """
    ...
    def access_token(self, access_token):
        """
        Sets the access_token of this CreateUser.
        Access token required to make the API call.

        :param access_token: The access_token of this CreateUser.
        :type: str
        """
    ...
    def nickname(self):
        """
        Gets the nickname of this CreateUser.
        An optional nickname (e.g. 'David from Sales').

        :return: The nickname of this CreateUser.
        :rtype: str
        """
    ...
    def nickname(self, nickname):
        """
        Sets the nickname of this CreateUser.
        An optional nickname (e.g. 'David from Sales').

        :param nickname: The nickname of this CreateUser.
        :type: str
        """
    ...
    def destination_folder(self):
        """
        Gets the destination_folder of this CreateUser.
        ...
        :return: The destination_folder of this CreateUser.
        :rtype: str
        """
    ...
    def destination_folder(self, destination_folder):
        """
        Sets the destination_folder of this CreateUser.
        The path to the user's home folder. For the account root, specify `/`. Otherwise, use standard Unix path format, e.g. `/path/to/some/dir`. The user will be locked to this directory and unable to move 'up' in the account.

        :param destination_folder: The destination_folder of this CreateUser.
        :type: str
        """
    ...
    def role(self):
        """
        Gets the role of this CreateUser.
        ...
        :return: The role of this CreateUser.
        :rtype: str
        """
        return self._role
    ...
    def role(self, role):
        """
        Sets the role of this CreateUser.
        The user's role. Note that admin users cannot have a `destinationFolder` other than `/`, and will be setup with full permissions regardless of what you specify in the `permissions` property.

        :param role: The role of this CreateUser.
        :type: str
        """
        if role is None:
    ...
    def permissions(self):
        """
        Gets the permissions of this CreateUser.
        ...
        :return: The permissions of this CreateUser.
        :rtype: str
        """
    ...
    def permissions(self, permissions):
        """
        Sets the permissions of this CreateUser.
        A CSV string of user permissions. For example: `upload,download,list`. Note that users will be unable to see any files in the account unless you include `list` permission.  

        :param permissions: The permissions of this CreateUser.
        :type: str
        """
        if permissions is None:
            raise ValueError("Invalid value for `permissions`, must not be `None`")
        allowed_values = ["upload", "download", "delete", "modify", "list", "changePassword", "share", "notification"]
    ...
    def time_zone(self):
        """
        Gets the time_zone of this CreateUser.
        ...
        :return: The time_zone of this CreateUser.
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """
        Sets the time_zone of this CreateUser.
        The user's timezone, used for accurate time display within the application. See <a href='https://php.net/manual/en/timezones.php' target='blank'>this page</a> for allowed values. 

        :param time_zone: The time_zone of this CreateUser.
        :type: str
        """
    ...
    def expiration(self):
        """
        Gets the expiration of this CreateUser.
        Optional timestamp when the user should expire, formatted `YYYY-mm-dd hh:mm:ss`.

        :return: The expiration of this CreateUser.
        :rtype: str
        """
    ...
    def expiration(self, expiration):
        """
        Sets the expiration of this CreateUser.
        Optional timestamp when the user should expire, formatted `YYYY-mm-dd hh:mm:ss`.

        :param expiration: The expiration of this CreateUser.
        :type: str
        """
    ...
    def locked(self):
        """
        Gets the locked of this CreateUser.
        If true, the user's account is locked by default.

        :return: The locked of this CreateUser.
        :rtype: bool
        """
        return self._locked
    ...
    def locked(self, locked):
        """
        Sets the locked of this CreateUser.
        If true, the user's account is locked by default.

        :param locked: The locked of this CreateUser.
        :type: bool
        """
    ...
    def welcome_email(self):
        """
        Gets the welcome_email of this CreateUser.
        ...
        :return: The welcome_email of this CreateUser.
        :rtype: bool
        """
    ...
    def welcome_email(self, welcome_email):
        """
        Sets the welcome_email of this CreateUser.
        If true, send a user email upon creation. The default welcome email can be configured from the settings page in your account.

        :param welcome_email: The welcome_email of this CreateUser.
        :type: bool
        """
