...
class Body5(object):
    ...
    @property
    def nickname(self):
        """Gets the nickname of this Body5.  # noqa: E501

        An optional nickname (e.g. 'David from Sales').  # noqa: E501

        :return: The nickname of this Body5.  # noqa: E501
        :rtype: str
        """
    ...
    def nickname(self, nickname):
        """Sets the nickname of this Body5.

        An optional nickname (e.g. 'David from Sales').  # noqa: E501

        :param nickname: The nickname of this Body5.  # noqa: E501
        :type: str
        """
    ...
    def home_resource(self):
        """Gets the home_resource of this Body5.  # noqa: E501
        ...
        :return: The home_resource of this Body5.  # noqa: E501
        :rtype: str
        """
    ...
    def home_resource(self, home_resource):
        """Sets the home_resource of this Body5.

        Resource identifier for the user's home folder. See details on [how to specify resources](#section/Identifying-Resources) above.  The user will be locked to this directory and unable to move 'up' in the account. If the folder does not exist in the account, it will be created when the user is created.   This setting is ignored for users with the `role` **admin**.  # noqa: E501

        :param home_resource: The home_resource of this Body5.  # noqa: E501
        :type: str
        """
    ...
    def permissions(self):
        """Gets the permissions of this Body5.  # noqa: E501
        ...
        :return: The permissions of this Body5.  # noqa: E501
        :rtype: str
        """
    ...
    def permissions(self, permissions):
        """Sets the permissions of this Body5.

        A CSV string of [user permissions](/docs/account/04-users/00-introduction#managing-user-roles-and-permissions). For example: **upload,download,list**. Note that users will be unable to see any files in the account unless you include **list** permission.   Valid permissions are **list**, **download**, **upload**, **modify**, **delete**, **changePassword**, **share**, **notification**, **viewFormData**, **deleteFormData**   # noqa: E501

        :param permissions: The permissions of this Body5.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time_zone(self):
        """Gets the time_zone of this Body5.  # noqa: E501
        ...
        :return: The time_zone of this Body5.  # noqa: E501
        :rtype: str
        """
    ...
    def time_zone(self, time_zone):
        """Sets the time_zone of this Body5.

        Time zone, used for accurate time display within the application. See <a href='https://php.net/manual/en/timezones.php' target='blank'>this page</a> for allowed values.   # noqa: E501

        :param time_zone: The time_zone of this Body5.  # noqa: E501
        :type: str
        """
    ...
    @property
    def expiration(self):
        """Gets the expiration of this Body5.  # noqa: E501

        Optional timestamp when the user should expire, formatted in date-time.  # noqa: E501

        :return: The expiration of this Body5.  # noqa: E501
        :rtype: str
        """
    ...
    def expiration(self, expiration):
        """Sets the expiration of this Body5.

        Optional timestamp when the user should expire, formatted in date-time.  # noqa: E501

        :param expiration: The expiration of this Body5.  # noqa: E501
        :type: str
        """
    ...
    @property
    def locked(self):
        """Gets the locked of this Body5.  # noqa: E501

        If true, the user will not be able to log in  # noqa: E501

        :return: The locked of this Body5.  # noqa: E501
        :rtype: bool
        """
        return self._locked
    ...
    def locked(self, locked):
        """Sets the locked of this Body5.

        If true, the user will not be able to log in  # noqa: E501

        :param locked: The locked of this Body5.  # noqa: E501
        :type: bool
        """
    ...
    def welcome_email(self):
        """Gets the welcome_email of this Body5.  # noqa: E501
        ...
        :return: The welcome_email of this Body5.  # noqa: E501
        :rtype: bool
        """
    ...
    def welcome_email(self, welcome_email):
        """Sets the welcome_email of this Body5.

        If **true**, send this new user a welcome email upon creation. The content of the welcome email can be configured with the [PATCH /accounts](#operation/updateAccount) method.  # noqa: E501

        :param welcome_email: The welcome_email of this Body5.  # noqa: E501
        :type: bool
        """
    ...
    def onboarding(self, onboarding):
        """Sets the onboarding of this Body5.

        Set this to **true** to enable extra help popups in the web file manager for this user.  # noqa: E501

        :param onboarding: The onboarding of this Body5.  # noqa: E501
        :type: bool
        """
