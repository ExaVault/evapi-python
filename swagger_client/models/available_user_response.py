...
class AvailableUserResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        AvailableUserResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this AvailableUserResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this AvailableUserResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this AvailableUserResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this AvailableUserResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this AvailableUserResponse.

        :return: The error of this AvailableUserResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this AvailableUserResponse.

        :param error: The error of this AvailableUserResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this AvailableUserResponse.

        :return: The results of this AvailableUserResponse.
        :rtype: AvailableUser
        """
    ...
    def results(self, results):
        """
        Sets the results of this AvailableUserResponse.

        :param results: The results of this AvailableUserResponse.
        :type: AvailableUser
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AvailableUserResponse):
            return False
