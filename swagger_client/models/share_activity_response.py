...
class ShareActivityResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        ShareActivityResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this ShareActivityResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this ShareActivityResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this ShareActivityResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this ShareActivityResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this ShareActivityResponse.

        :return: The error of this ShareActivityResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this ShareActivityResponse.

        :param error: The error of this ShareActivityResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this ShareActivityResponse.
        Array of ShareLogEntry objects.

        :return: The results of this ShareActivityResponse.
        :rtype: list[ShareLogEntry]
        """
    ...
    def results(self, results):
        """
        Sets the results of this ShareActivityResponse.
        Array of ShareLogEntry objects.

        :param results: The results of this ShareActivityResponse.
        :type: list[ShareLogEntry]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ShareActivityResponse):
            return False
