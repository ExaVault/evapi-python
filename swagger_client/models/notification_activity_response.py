...
class NotificationActivityResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        NotificationActivityResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this NotificationActivityResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this NotificationActivityResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this NotificationActivityResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this NotificationActivityResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this NotificationActivityResponse.

        :return: The error of this NotificationActivityResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this NotificationActivityResponse.

        :param error: The error of this NotificationActivityResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this NotificationActivityResponse.
        Array of NotificationMessage objects.

        :return: The results of this NotificationActivityResponse.
        :rtype: list[NotificationMessage]
        """
    ...
    def results(self, results):
        """
        Sets the results of this NotificationActivityResponse.
        Array of NotificationMessage objects.

        :param results: The results of this NotificationActivityResponse.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, NotificationActivityResponse):
            return False
