...
class SharesResponse(object):
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        SharesResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this SharesResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this SharesResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this SharesResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this SharesResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this SharesResponse.

        :return: The error of this SharesResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this SharesResponse.

        :param error: The error of this SharesResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this SharesResponse.
        Array of Share objects.

        :return: The results of this SharesResponse.
        :rtype: list[Share]
        """
    ...
    def results(self, results):
        """
        Sets the results of this SharesResponse.
        Array of Share objects.

        :param results: The results of this SharesResponse.
        :type: list[Share]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SharesResponse):
            return False
