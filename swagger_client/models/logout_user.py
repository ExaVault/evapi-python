...
class LogoutUser(object):
    ...
    def __init__(self, access_token=None):
        """
        LogoutUser - a model defined in Swagger
        """
    ...
    def access_token(self):
        """
        Gets the access_token of this LogoutUser.
        Access token required to make the API call.

        :return: The access_token of this LogoutUser.
        :rtype: str
        """
    ...
    def access_token(self, access_token):
        """
        Sets the access_token of this LogoutUser.
        Access token required to make the API call.

        :param access_token: The access_token of this LogoutUser.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, LogoutUser):
            return False
