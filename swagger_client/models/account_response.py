...
class AccountResponse(object):
    ...
    def success(self):
        """
        Gets the success of this AccountResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this AccountResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this AccountResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this AccountResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this AccountResponse.

        :return: The error of this AccountResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this AccountResponse.

        :param error: The error of this AccountResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this AccountResponse.

        :return: The results of this AccountResponse.
        :rtype: Account
        """
    ...
    def results(self, results):
        """
        Sets the results of this AccountResponse.

        :param results: The results of this AccountResponse.
        :type: Account
        """
