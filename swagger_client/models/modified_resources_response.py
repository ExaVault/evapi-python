...
class ModifiedResourcesResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        ModifiedResourcesResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this ModifiedResourcesResponse.
        ...
        :return: The success of this ModifiedResourcesResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this ModifiedResourcesResponse.
        Flag indicates API call status. `0` is failure; `1` is success; `2` means partial success - some but not all files were moved, copied or deleted.

        :param success: The success of this ModifiedResourcesResponse.
        :type: int
        """
    ...
    def error(self):
        """
        Gets the error of this ModifiedResourcesResponse.

        :return: The error of this ModifiedResourcesResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this ModifiedResourcesResponse.

        :param error: The error of this ModifiedResourcesResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this ModifiedResourcesResponse.
        

        :return: The results of this ModifiedResourcesResponse.
        :rtype: list[ModifiedResource]
        """
    ...
    def results(self, results):
        """
        Sets the results of this ModifiedResourcesResponse.
        

        :param results: The results of this ModifiedResourcesResponse.
        :type: list[ModifiedResource]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ModifiedResourcesResponse):
            return False
