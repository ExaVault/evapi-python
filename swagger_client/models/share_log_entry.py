...
class ShareLogEntry(object):
    ...
    def __init__(self, id=None, share_id=None, username=None, action=None, action_object_id=None, detail=None, created=None):
        """
        ShareLogEntry - a model defined in Swagger
        """
    ...
    def id(self):
        """
        Gets the id of this ShareLogEntry.
        ID of the log entry.

        :return: The id of this ShareLogEntry.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this ShareLogEntry.
        ID of the log entry.

        :param id: The id of this ShareLogEntry.
        :type: int
        """
    ...
    def share_id(self):
        """
        Gets the share_id of this ShareLogEntry.
        ID of the share this log entry belongs to.

        :return: The share_id of this ShareLogEntry.
        :rtype: str
        """
    ...
    def share_id(self, share_id):
        """
        Sets the share_id of this ShareLogEntry.
        ID of the share this log entry belongs to.

        :param share_id: The share_id of this ShareLogEntry.
        :type: str
        """
    ...
    def username(self):
        """
        Gets the username of this ShareLogEntry.
        Username of the user triggered the action.

        :return: The username of this ShareLogEntry.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this ShareLogEntry.
        Username of the user triggered the action.

        :param username: The username of this ShareLogEntry.
        :type: str
        """
    ...
    def action(self):
        """
        Gets the action of this ShareLogEntry.
        Type of the action that happened in the share.

        :return: The action of this ShareLogEntry.
        :rtype: str
        """
        return self._action
    ...
    def action(self, action):
        """
        Sets the action of this ShareLogEntry.
        Type of the action that happened in the share.

        :param action: The action of this ShareLogEntry.
        :type: str
        """
    ...
    def action_object_id(self):
        """
        Gets the action_object_id of this ShareLogEntry.
        ID of the object that the action happened to.

        :return: The action_object_id of this ShareLogEntry.
        :rtype: str
        """
    ...
    def action_object_id(self, action_object_id):
        """
        Sets the action_object_id of this ShareLogEntry.
        ID of the object that the action happened to.

        :param action_object_id: The action_object_id of this ShareLogEntry.
        :type: str
        """
    ...
    def detail(self):
        """
        Gets the detail of this ShareLogEntry.
        Recipients the share was sent to.

        :return: The detail of this ShareLogEntry.
        :rtype: str
        """
        return self._detail
    ...
    def detail(self, detail):
        """
        Sets the detail of this ShareLogEntry.
        Recipients the share was sent to.

        :param detail: The detail of this ShareLogEntry.
        :type: str
        """
    ...
    def created(self):
        """
        Gets the created of this ShareLogEntry.
        Timestamp of the operation.

        :return: The created of this ShareLogEntry.
        :rtype: str
        """
    ...
    def created(self, created):
        """
        Sets the created of this ShareLogEntry.
        Timestamp of the operation.

        :param created: The created of this ShareLogEntry.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ShareLogEntry):
            return False
