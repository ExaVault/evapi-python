...
class ExistingResourcesResponse(object):
    """
    ...
    def __init__(self, success=None, error=None, results=None):
        """
        ExistingResourcesResponse - a model defined in Swagger
        """
    ...
    def success(self):
        """
        Gets the success of this ExistingResourcesResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this ExistingResourcesResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this ExistingResourcesResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this ExistingResourcesResponse.
        :type: int
        """
        allowed_values = [0, 1]
        if success not in allowed_values:
            raise ValueError(
                "Invalid value for `success` ({0}), must be one of {1}"
                .format(success, allowed_values)
            )
    ...
    def error(self):
        """
        Gets the error of this ExistingResourcesResponse.

        :return: The error of this ExistingResourcesResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this ExistingResourcesResponse.

        :param error: The error of this ExistingResourcesResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this ExistingResourcesResponse.
        Array of resources.

        :return: The results of this ExistingResourcesResponse.
        :rtype: list[ExistingResource]
        """
    ...
    def results(self, results):
        """
        Sets the results of this ExistingResourcesResponse.
        Array of resources.

        :param results: The results of this ExistingResourcesResponse.
        :type: list[ExistingResource]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, ExistingResourcesResponse):
            return False
