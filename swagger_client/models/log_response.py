...
class LogResponse(object):
    ...
    def success(self):
        """
        Gets the success of this LogResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :return: The success of this LogResponse.
        :rtype: int
        """
    ...
    def success(self, success):
        """
        Sets the success of this LogResponse.
        Flag indicates API call status. `0` is failure; `1` is success.

        :param success: The success of this LogResponse.
        :type: int
        """
        allowed_values = [0, 1]
    ...
    def error(self):
        """
        Gets the error of this LogResponse.

        :return: The error of this LogResponse.
        :rtype: object
        """
        return self._error
    ...
    def error(self, error):
        """
        Sets the error of this LogResponse.

        :param error: The error of this LogResponse.
        :type: object
        """
    ...
    def results(self):
        """
        Gets the results of this LogResponse.
        Array of LogEntry objects.

        :return: The results of this LogResponse.
        :rtype: list[LogEntry]
        """
    ...
    def results(self, results):
        """
        Sets the results of this LogResponse.
        Array of LogEntry objects.

        :param results: The results of this LogResponse.
        :type: list[LogEntry]
        """
