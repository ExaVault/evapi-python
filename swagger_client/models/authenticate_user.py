...
class AuthenticateUser(object):
    ...
    def __init__(self, username=None, password=None):
        """
        AuthenticateUser - a model defined in Swagger
        """
    ...
    def username(self):
        """
        Gets the username of this AuthenticateUser.
        Name of the user to authenticate.

        :return: The username of this AuthenticateUser.
        :rtype: str
        """
    ...
    def username(self, username):
        """
        Sets the username of this AuthenticateUser.
        Name of the user to authenticate.

        :param username: The username of this AuthenticateUser.
        :type: str
        """
        if username is None:
    ...
    def password(self):
        """
        Gets the password of this AuthenticateUser.
        User's password.

        :return: The password of this AuthenticateUser.
        :rtype: str
        """
    ...
    def password(self, password):
        """
        Sets the password of this AuthenticateUser.
        User's password.

        :param password: The password of this AuthenticateUser.
        :type: str
        """
        if password is None:
