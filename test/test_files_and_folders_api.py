...
from swagger_client.apis.files_and_folders_api import FilesAndFoldersApi


class TestFilesAndFoldersApi(unittest.TestCase):
    """ FilesAndFoldersApi unit test stubs """

    def setUp(self):
        self.api = swagger_client.apis.files_and_folders_api.FilesAndFoldersApi()
    ...
    def test_check_files_exist(self):
        """
        Test case for check_files_exist
    ...
    def test_get_download_file_url(self):
        """
    ...
    def test_get_resource_list(self):
        """
        Test case for get_resource_list
