...
from swagger_client.apis.activity_api import ActivityApi
...
class TestActivityApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.activity_api.ActivityApi()

    def tearDown(self):
        pass

    def test_get_file_activity_logs(self):
        """
        Test case for get_file_activity_logs

        getFileActivityLogs
        """
        pass

    def test_get_notification_activity(self):
        """
        Test case for get_notification_activity

        getNotificationActivity
        """
        pass

    def test_get_share_activity(self):
        """
        Test case for get_share_activity
