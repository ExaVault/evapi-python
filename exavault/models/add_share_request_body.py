...
class AddShareRequestBody(object):
    ...
    def __init__(self, type=None, name=None, resources=None, access_mode=None, embed=None, recipients=None, expiration=None, has_notification=None, is_public=None, message=None, notification_emails=None, password=None, require_email=None, message_subject=None, file_drop_create_folders=None, sending_local_files=None):  # noqa: E501
    ...
    def access_mode(self, access_mode):
        ...
        allowed_values = ["upload", "download", "delete", "modify"]  # noqa: E501
        if not set(access_mode).issubset(set(allowed_values)):
            raise ValueError(
                "Invalid values for `access_mode` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(access_mode) - set(allowed_values))),  # noqa: E501
    ...
    @property
    def message(self):
        """Gets the message of this AddShareRequestBody.  # noqa: E501
        ...
        :return: The message of this AddShareRequestBody.  # noqa: E501
        :rtype: str
        """
    ...
    def message(self, message):
        """Sets the message of this AddShareRequestBody.

        The message to be included in email invitations for your recipients. Ignored if you have not also provided `recipients` and `subject`  # noqa: E501

        :param message: The message of this AddShareRequestBody.  # noqa: E501
        :type: str
        """
